...
class ConveyorBeltGeometry:
    ...
    def generate_bed_structure_mesh(self) -> Tuple[np.ndarray, np.ndarray, dict]:
        ...
        # NOTE: Attenuation ducts are generated by the feed tunnel and
        # outfeed tunnel components, which attach to the oven chamber
        # infeed/outfeed walls.  Previously placed here at the conveyor
        # nose sections — removed to avoid duplication.
